...
export function AdminDashboard({
  ...
  const [editingProduct, setEditingProduct] = useState<ProductClickAnalytics | null>(
    null
  );
  ...
  useEffect(() => {
    if (!isCreateModalOpen && !editingProduct) {
      return;
    }
  ...
  const filteredProducts = useMemo(() => {
    ...
    nextProducts.sort((left, right) => {
      if (sortMode === "least-clicked") {
        return left.total_clicks - right.total_clicks;
      }
      ...
      <main className="admin-shell">
        <section className="admin-hero">
          <div className="admin-hero-copy">
            <p className="admin-eyebrow">Dashboard dos produtos</p>
            <h1 className="admin-display-title">
              Controle os cliques e os produtos sem sair do painel.
            </h1>
            <p className="admin-copy max-w-[60ch]">
              Bem-vindo, {adminDisplayName}. Aqui voce acompanha o desempenho
              dos produtos, enxerga os botoes mais usados e cadastra novos itens
              quando precisar, sem dividir a tela principal.
            </p>
          </div>
        ...
        {statusMessage ? (
          <div className="admin-alert admin-alert-success admin-page-alert">
            {statusMessage}
          </div>
        ) : null}
        ...
        <section className="admin-metrics-grid">
          <article className="admin-stat-card">
            ...
            <strong className="admin-stat-value">
              {formatCount(dashboardData.totals.totalProducts)}
            </strong>
          </article>
            ...
            <div className="admin-section-head">
              <div>
                ...
                <h2 className="admin-title mt-2">
                  Veja os mais clicados, os menos clicados e os recem-criados.
                </h2>
              </div>
            ...
            <div className="admin-filter-row">
              <button
                ...
                className={`admin-chip ${
                  sortMode === "most-clicked" ? "admin-chip-active" : ""
                }`}
              ...
              <button
                type="button"
                className={`admin-chip ${
                  sortMode === "least-clicked" ? "admin-chip-active" : ""
                }`}
              ...
              <button
                type="button"
                className={`admin-chip ${
                  sortMode === "latest" ? "admin-chip-active" : ""
                }`}
            ...
            <div className="admin-product-list">
              {filteredProducts.length === 0 ? (
                ...
                filteredProducts.map((product) => {
                  const ratio =
                    maxClicks > 0
                      ? Math.max(product.total_clicks / maxClicks, 0.08)
                      : 0.08;
                    ...
                    <article key={product.id} className="admin-product-card">
                      <div className="admin-product-media">
                        <Image
                          ...
                          alt={product.titulo}
                          fill
                          sizes="(max-width: 639px) 100vw, (max-width: 1023px) 124px, 172px"
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-3">
                          <div>
                            ...
                            <p className="admin-copy mt-2">
                              ...
                              {product.preco?.trim() || "Sob consulta"}
                            </p>
                          </div>
            ...
            <section className="admin-panel">
              <div className="admin-section-head">
                <div>
                  ...
                  <h2 className="admin-title mt-2">
                    Ranking agregado dos cliques em todos os botoes rastreados.
                  </h2>
                </div>
              </div>
              ...
              <div className="admin-button-grid">
                {dashboardData.buttonAnalytics.map((button) => (
                  <article key={button.button_key} className="admin-button-card">
                    ...
                    <strong className="admin-button-value">
                      {formatCount(button.total_clicks)} cliques
                    </strong>
                    <span className="admin-button-meta">
                      Chave: {button.button_key}
                    </span>
                    <span className="admin-button-meta">
                      Pagina: {button.sample_path || "/"}
                    </span>
                    <span className="admin-button-meta">
            ...
            <section className="admin-panel">
              <div className="admin-section-head">
                <div>
                  ...
                  <h2 className="admin-title mt-2">
                    Ultimos cliques registrados pelo site.
                  </h2>
                </div>
              </div>
              ...
              <div className="admin-activity-list">
                {dashboardData.recentClicks.length === 0 ? (
                  <div className="admin-empty-state">
                    Ainda nao existem cliques registrados.
                  </div>
                ) : (
          ...
          <div className="admin-modal-backdrop" onClick={closeCreateModal}>
            ...
            >
              <div className="admin-modal-header">
                <div>
                  <p className="admin-eyebrow">Cadastrar produto</p>
                  <h2 className="admin-title mt-2">
                    Clique no botao + sempre que quiser adicionar um novo achado.
                  </h2>
                </div>
              ...
              <form className="space-y-4" onSubmit={handleCreateProduct}>
                ...
                <div className="admin-image-mode-row">
                  <button
                    type="button"
                    className={`admin-chip ${
                      imageMode === "url" ? "admin-chip-active" : ""
                    }`}
                  ...
                  <button
                    type="button"
                    className={`admin-chip ${
                      imageMode === "upload" ? "admin-chip-active" : ""
                    }`}
        ...
        {editingProduct ? (
          <div className="admin-modal-backdrop" onClick={closeEditModal}>
            ...
            >
              <div className="admin-modal-header">
                <div>
                  <p className="admin-eyebrow">Editar produto</p>
                  <h2 className="admin-title mt-2">
              ...
              <form className="space-y-4" onSubmit={handleUpdateProduct}>
                ...
                <input
                  ...
                  value={editingProduct.url_imagem}
                />
